...
if ( -e "$xml_temp/workfile-36.xml")
{
    ...
    qx{"$path/imdbtask_1.pl" "$xml_temp"workfile-33.xml > "$xml_temp"mappedfile-33.xml & "$path/imdbtask_2.pl" "$xml_temp"workfile-34.xml > "$xml_temp"mappedfile-34.xml & "$path/imdbtask_3.pl" "$xml_temp"workfile-35.xml > "$xml_temp"mappedfile-35.xml & "$path/imdbtask_4.pl" "$xml_temp"workfile-36.xml > "$xml_temp"mappedfile-36.xml};
    }
    elsif ( -e "$xml_temp/workfile-35.xml")
    {
        print STDERR "Reading XML Part 33, 34 and 35 Together for faster ImdB Download\n";
        qx{"$path/imdbtask_1.pl" "$xml_temp"workfile-33.xml > "$xml_temp"mappedfile-33.xml & "$path/imdbtask_2.pl" "$xml_temp"workfile-34.xml > "$xml_temp"mappedfile-34.xml & "$path/imdbtask_3.pl" "$xml_temp"workfile-35.xml > "$xml_temp"mappedfile-35.xml};
            }
            elsif ( -e "$xml_temp/workfile-34.xml")
            {
                print STDERR "Reading XML Part 33 and 34 Together for faster ImdB Download\n";
                qx{"$path/imdbtask_1.pl" "$xml_temp"workfile-33.xml > "$xml_temp"mappedfile-33.xml & "$path/imdbtask_2.pl" "$xml_temp"workfile-34.xml > "$xml_temp"mappedfile-34.xml};
                    }
                    elsif ( -e "$xml_temp/workfile-33.xml")
                     {
                        print STDERR "Reading XML Part 33\n";
                        qx{"$path/imdbtask_1.pl" "$xml_temp"workfile-33.xml > "$xml_temp"mappedfile-33.xml};
                            }
...
if ( -e "$xml_temp/workfile-40.xml")
{
    ...
    qx{"$path/imdbtask_1.pl" "$xml_temp"workfile-37.xml > "$xml_temp"mappedfile-37.xml & "$path/imdbtask_2.pl" "$xml_temp"workfile-38.xml > "$xml_temp"mappedfile-38.xml & "$path/imdbtask_3.pl" "$xml_temp"workfile-39.xml > "$xml_temp"mappedfile-39.xml & "$path/imdbtask_4.pl" "$xml_temp"workfile-40.xml > "$xml_temp"mappedfile-40.xml};
    }
    elsif ( -e "$xml_temp/workfile-39.xml")
    {
        print STDERR "Reading XML Part 37, 38 and 39 Together for faster ImdB Download\n";
        qx{"$path/imdbtask_1.pl" "$xml_temp"workfile-37.xml > "$xml_temp"mappedfile-37.xml & "$path/imdbtask_2.pl" "$xml_temp"workfile-38.xml > "$xml_temp"mappedfile-38.xml & "$path/imdbtask_3.pl" "$xml_temp"workfile-39.xml > "$xml_temp"mappedfile-39.xml};
            }
            elsif ( -e "$xml_temp/workfile-38.xml")
            {
                print STDERR "Reading XML Part 37 and 38 Together for faster ImdB Download\n";
                qx{"$path/imdbtask_1.pl" "$xml_temp"workfile-37.xml > "$xml_temp"mappedfile-37.xml & "$path/imdbtask_2.pl" "$xml_temp"workfile-38.xml > "$xml_temp"mappedfile-38.xml};
                    }
                    elsif ( -e "$xml_temp/workfile-37.xml")
                     {
                        print STDERR "Reading XML Part 37\n";
                        qx{"$path/imdbtask_1.pl" "$xml_temp"workfile-37.xml > "$xml_temp"mappedfile-37.xml};
                            }
...
if ( -e "$xml_temp/workfile-44.xml")
{
    ...
    qx{"$path/imdbtask_1.pl" "$xml_temp"workfile-41.xml > "$xml_temp"mappedfile-41.xml & "$path/imdbtask_2.pl" "$xml_temp"workfile-42.xml > "$xml_temp"mappedfile-42.xml & "$path/imdbtask_3.pl" "$xml_temp"workfile-43.xml > "$xml_temp"mappedfile-43.xml & "$path/imdbtask_4.pl" "$xml_temp"workfile-44.xml > "$xml_temp"mappedfile-44.xml};
    }
    elsif ( -e "$xml_temp/workfile-43.xml")
    {
        print STDERR "Reading XML Part 41, 42 and 43 Together for faster ImdB Download\n";
        qx{"$path/imdbtask_1.pl" "$xml_temp"workfile-41.xml > "$xml_temp"mappedfile-41.xml & "$path/imdbtask_2.pl" "$xml_temp"workfile-42.xml > "$xml_temp"mappedfile-42.xml & "$path/imdbtask_3.pl" "$xml_temp"workfile-43.xml > "$xml_temp"mappedfile-43.xml};
            }
            elsif ( -e "$xml_temp/workfile-42.xml")
            {
                print STDERR "Reading XML Part 41 and 42 Together for faster ImdB Download\n";
                qx{"$path/imdbtask_1.pl" "$xml_temp"workfile-41.xml > "$xml_temp"mappedfile-41.xml & "$path/imdbtask_2.pl" "$xml_temp"workfile-42.xml > "$xml_temp"mappedfile-42.xml};
                    }
                    elsif ( -e "$xml_temp/workfile-41.xml")
                     {
                        print STDERR "Reading XML Part 41\n";
                        qx{"$path/imdbtask_1.pl" "$xml_temp"workfile-41.xml > "$xml_temp"mappedfile-41.xml};
                            }
...
if ( -e "$xml_temp/workfile-48.xml")
{
    ...
    qx{"$path/imdbtask_1.pl" "$xml_temp"workfile-45.xml > "$xml_temp"mappedfile-45.xml & "$path/imdbtask_2.pl" "$xml_temp"workfile-46.xml > "$xml_temp"mappedfile-46.xml & "$path/imdbtask_3.pl" "$xml_temp"workfile-47.xml > "$xml_temp"mappedfile-47.xml & "$path/imdbtask_4.pl" "$xml_temp"workfile-48.xml > "$xml_temp"mappedfile-48.xml};
    }
    elsif ( -e "$xml_temp/workfile-47.xml")
    {
        print STDERR "Reading XML Part 45, 46 and 47 Together for faster ImdB Download\n";
        qx{"$path/imdbtask_1.pl" "$xml_temp"workfile-45.xml > "$xml_temp"mappedfile-45.xml & "$path/imdbtask_2.pl" "$xml_temp"workfile-46.xml > "$xml_temp"mappedfile-46.xml & "$path/imdbtask_3.pl" "$xml_temp"workfile-47.xml > "$xml_temp"mappedfile-47.xml};
            }
            elsif ( -e "$xml_temp/workfile-46.xml")
            {
                print STDERR "Reading XML Part 45 and 46 Together for faster ImdB Download\n";
                qx{"$path/imdbtask_1.pl" "$xml_temp"workfile-45.xml > "$xml_temp"mappedfile-45.xml & "$path/imdbtask_2.pl" "$xml_temp"workfile-46.xml > "$xml_temp"mappedfile-46.xml};
                    }
                    elsif ( -e "$xml_temp/workfile-45.xml")
                     {
                        print STDERR "Reading XML Part 45\n";
                        qx{"$path/imdbtask_1.pl" "$xml_temp"workfile-45.xml > "$xml_temp"mappedfile-45.xml};
                            }
...
if ( -e "$xml_temp/workfile-52.xml")
{
    ...
    qx{"$path/imdbtask_1.pl" "$xml_temp"workfile-49.xml > "$xml_temp"mappedfile-49.xml & "$path/imdbtask_2.pl" "$xml_temp"workfile-50.xml > "$xml_temp"mappedfile-50.xml & "$path/imdbtask_3.pl" "$xml_temp"workfile-51.xml > "$xml_temp"mappedfile-51.xml & "$path/imdbtask_4.pl" "$xml_temp"workfile-52.xml > "$xml_temp"mappedfile-52.xml};
    }
    elsif ( -e "$xml_temp/workfile-51.xml")
    {
        print STDERR "Reading XML Part 49, 50 and 51 Together for faster ImdB Download\n";
        qx{"$path/imdbtask_1.pl" "$xml_temp"workfile-49.xml > "$xml_temp"mappedfile-49.xml & "$path/imdbtask_2.pl" "$xml_temp"workfile-50.xml > "$xml_temp"mappedfile-50.xml & "$path/imdbtask_3.pl" "$xml_temp"workfile-51.xml > "$xml_temp"mappedfile-51.xml};
            }
            elsif ( -e "$xml_temp/workfile-50.xml")
            {
                print STDERR "Reading XML Part 49 and 50 Together for faster ImdB Download\n";
                qx{"$path/imdbtask_1.pl" "$xml_temp"workfile-49.xml > "$xml_temp"mappedfile-49.xml & "$path/imdbtask_2.pl" "$xml_temp"workfile-50.xml > "$xml_temp"mappedfile-50.xml};
                    }
                    elsif ( -e "$xml_temp/workfile-49.xml")
                     {
                        print STDERR "Reading XML Part 49\n";
                        qx{"$path/imdbtask_1.pl" "$xml_temp"workfile-49.xml > "$xml_temp"mappedfile-49.xml};
                            }
